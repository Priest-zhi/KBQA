...
def GetCQL(QuestionIndex, KeywordList):
    if QuestionIndex == 0:
        ...
        CQL="MATCH p=(n1:Chemical)-[r:father]->(n:Chemical) WHERE n1.id='{0}' or n1.name='{0}' RETURN p".format(KeywordList[0])
    elif QuestionIndex == 6:
        CQL="MATCH p=(n1:Chemical)-[r]-(n:GO) WHERE n.id='{0}' or n.name='{0}' RETURN p".format(KeywordList[0])
    elif QuestionIndex == 7:
        CQL="MATCH p=(n1:Chemical)-[r]-(n:GENE) WHERE n.id='{0}' or n.name='{0}' RETURN p".format(KeywordList[0])
    elif QuestionIndex == 8:
        CQL = "MATCH p=(n1:Chemical)-[r]-(n:Pathway) WHERE n.id='{0}' or n.name='{0}' RETURN p".format(KeywordList[0])
    elif QuestionIndex == 9:
        CQL="MATCH p=(n1:Chemical)-[r]-(n:Disease) WHERE n1.id='{0}' or n1.name='{0}' RETURN p".format(KeywordList[0])
    elif QuestionIndex == 10:
        CQL="MATCH p=(n1:Chemical)-[r]-(n:Exposure) WHERE n.id='{0}' or n.name='{0}' RETURN p".format(KeywordList[0])
        ...
        CQL="MATCH p=(n1:GO)-[r]-(n) WHERE n1.id='{0}' or n1.name='{0}' RETURN p".format(KeywordList[0])
    elif QuestionIndex == 16:
        CQL="MATCH p=(n1:GO)-[r:father]->(n:GO) WHERE n1.id='{0}' or n1.name='{0}' RETURN p".format(KeywordList[0])
    elif QuestionIndex == 17:
        CQL = "MATCH p=(n1:GO)-[r]-(n:GENE) WHERE n1.id='{0}' or n1.name='{0}' RETURN p".format(KeywordList[0])
    elif QuestionIndex == 18:
        CQL = "MATCH p=(n1:GO)-[r]-(n:Chemical) WHERE n1.id='{0}' or n1.name='{0}' RETURN p".format(KeywordList[0])
        ...
        CQL = "MATCH p=(n1:GENE)-[r]-(n) WHERE n1.attribute_gene_name='{0}' RETURN p".format(KeywordList[0])
    elif QuestionIndex == 27:
        CQL = "MATCH p=(n1:GENE)-[r]-(n:GO) WHERE n1.attribute_gene_name='{0}' RETURN p".format(KeywordList[0])
    elif QuestionIndex == 28:
        CQL = "MATCH p=(n1:GENE)-[r]-(n:Chemical) WHERE n1.attribute_gene_name='{0}' RETURN p".format(KeywordList[0])
    elif QuestionIndex == 29:
        CQL = "MATCH p=(n1:GENE)-[r]-(n:Pathway) WHERE n1.attribute_gene_name='{0}' RETURN p".format(KeywordList[0])
    elif QuestionIndex == 30:
        CQL = "MATCH p=(n1:GENE)-[r]-(n:HPO) WHERE n1.attribute_gene_name='{0}' RETURN p".format(KeywordList[0])
        ...
        CQL = "MATCH p=(n1:HPO)-[r:father]->(n:HPO) WHERE n1.id='{0}' or n1.name='{0}' RETURN p".format(KeywordList[0])
    elif QuestionIndex == 37:
        CQL = "MATCH p=(n:HPO)-[r:father]->(n1:HPO) WHERE n1.id='{0}' or n1.name='{0}' RETURN p".format(KeywordList[0])
    elif QuestionIndex == 38:
        CQL = "MATCH p=(n1:HPO)-[r]-(n:GENE) WHERE n1.id='{0}' or n1.name='{0}' RETURN p".format(KeywordList[0])
    elif QuestionIndex == 39:
        CQL = "MATCH p=(n1:HPO)-[r]-(n:OMIM) WHERE n1.id='{0}' or n1.name='{0}' RETURN p".format(KeywordList[0])
        ...
        CQL = "MATCH p=(n1:DO)-[r:father]->(n:DO) WHERE n1.id='{0}' or n1.name='{0}' RETURN p".format(KeywordList[0])
    elif QuestionIndex == 45:
        CQL = "MATCH p=(n:DO)-[r:father]->(n1:DO) WHERE n1.id='{0}' or n1.name='{0}' RETURN p".format(KeywordList[0])
    elif QuestionIndex == 46:
        CQL = "MATCH p=(n1:DO)-[r]-(n:Disease) WHERE n1.id='{0}' or n1.name='{0}' RETURN p".format(KeywordList[0])
    elif QuestionIndex == 47:
        CQL = "MATCH p=(n1:DO)-[r]-(n:OMIM) WHERE n1.id='{0}' or n1.name='{0}' RETURN p".format(KeywordList[0])
        ...
        CQL = "MATCH p=(n1:OMIM)-[r]-(n:Disease) WHERE n1.id='{0}' or n1.name='{0}' RETURN p".format(KeywordList[0])
    elif QuestionIndex == 52:
        CQL = "MATCH p=(n1:OMIM)-[r]-(n:HPO) WHERE n1.id='{0}' or n1.name='{0}' RETURN p".format(KeywordList[0])
    elif QuestionIndex == 53:
        CQL = "MATCH p=(n1:OMIM)-[r]-(n:DO) WHERE n1.id='{0}' or n1.name='{0}' RETURN p".format(KeywordList[0])
        ...
        CQL = "MATCH p=(n1:Exposure)-[r]-(n:Disease) WHERE ANY (ex in n1.exposurestressors where ex =~ '(?i).*{0}.*') RETURN p".format(KeywordList[0])
    elif QuestionIndex == 59:
        CQL = "MATCH p=(n1:Exposure)-[r]-(n:Chemical) WHERE ANY (ex in n1.exposurestressors where ex =~ '(?i).*{0}.*') RETURN p".format(KeywordList[0])
        ...
        CQL = "MATCH p=(n1:Disease)-[r]-(n:Chemical) WHERE n1.id='{0}' or n1.name='{0}' RETURN p".format(KeywordList[0])
    elif QuestionIndex == 64:
        CQL = "MATCH p=(n1:Disease)-[r]-(n:Pathway) WHERE n1.id='{0}' or n1.name='{0}' RETURN p".format(KeywordList[0])
    elif QuestionIndex == 65:
        CQL = "MATCH p=(n1:Disease)-[r]-(n:DO) WHERE n.id='{0}' or n.name='{0}' RETURN p".format(KeywordList[0])
    elif QuestionIndex == 66:
        CQL = "MATCH p=(n1:Disease)-[r]-(n:DO) WHERE n.id='{0}' or n.name='{0}' RETURN p".format(KeywordList[0])
    elif QuestionIndex == 67:
        CQL = "MATCH p=(n1:Disease)-[r]-(n:OMIM) WHERE n.id='{0}' or n.name='{0}' RETURN p".format(KeywordList[0])
    elif QuestionIndex == 68:
        CQL = "MATCH p=(n1:Disease)-[r]-(n:Exposure) WHERE n.id='{0}' or n.name='{0}' RETURN p".format(KeywordList[0])
        ...
        CQL = "MATCH p=(n1:Pathway)-[r]-(n:Chemical) WHERE n1.id='{0}' or n1.name='{0}' RETURN p".format(KeywordList[0])
    elif QuestionIndex == 74:
        CQL = "MATCH p=(n1:Pathway)-[r]-(n:GENE) WHERE n1.id='{0}' or n1.name='{0}' RETURN p".format(KeywordList[0])
    elif QuestionIndex == 75:
        CQL = "MATCH p=(n1:Pathway)-[r]-(n:Disease) WHERE n.id='{0}' or n.name='{0}' RETURN p".format(KeywordList[0])
    elif QuestionIndex == 76:
